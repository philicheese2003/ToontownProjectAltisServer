...
class DistributedCashbotBoss(DistributedBossCog.DistributedBossCog, FSM.FSM):
    ...
    def announceGenerate(self):
        ...
        self.standinCFO = Suit.Suit()
        self.standinCFO.dna = SuitDNA.SuitDNA()
        self.standinCFO.dna.newSuit('rb')
        self.standinCFO.setDNA(self.standinCFO.dna)
        self.standinCFO.reparentTo(self)
        self.standinCFO.loop('neutral')
        self.standinCFO.setDisplayName('C.F.O SkelePro v0.1 Alpha\nBossCog\nLevel: 50')
        self.standinCFO.setScale(1)
            ...
            Parallel(
                ...
                Sequence(
                    ...
                    Parallel(
                        ...
                        Func(self.standinCFO.loop, 'walk'),
                        ...
                        Parallel(
                            ...
                            Func(self.standinCFO.loop, 'neutral'),
                            Func(self.standinCFO.setChatAbsolute, TTL.CashbotBossDiscoverToons1, CFSpeech),
                            LerpColorScaleInterval(render, 1, Vec4(0.75, 1.0, 0.75, 1.0)),
                            Func(self.standinCFO.setChatAbsolute, TTL.CashbotBossDiscoverToons2, CFSpeech),
                            Wait(4),
                            Func(self.clearChat),
                            ...
                            Sequence(
                                ...
                                Parallel(
                                    ...
                                    Func(self.standinCFO.setChatAbsolute, attackToons, CFSpeech),
                                    Wait(2),
                                    Func(self.standinCFO.clearChat))
