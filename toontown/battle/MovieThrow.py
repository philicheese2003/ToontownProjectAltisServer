...
hitSoundFiles = ('AA_tart_only.ogg', 'AA_slice_only.ogg', 'AA_slice_only.ogg', 'AA_throw_cream_pie_cog.ogg', 'AA_throw_cream_pie_cog.ogg', 'AA_throw_cream_pie_cog.ogg', 'AA_throw_wedding_cake_cog.ogg', 'AA_throw_wedding_cake_cog.ogg')
tPieLeavesHand = 2.7
tPieHitsSuit = 3.0
tSuitDodges = 2.45
ratioMissToHit = 1.5
...
def __throwPie(throw, delay, hitCount, npcs):
    ...
    if level == 3:
        ...
        pie = loader.loadModel('phase_3.5/models/props/BirthdayCakeSlice.bam')
        tex = loader.loadTexture('phase_3.5/maps/BirthdayCakeSlice.png')
        pie.setTexture(tex, 1)
        pie.setHpr(-90, 90, 0)
        pie.setPos(0, 0, 0.5)
    else:
